...
감사인이 충분한 증거를 얻기 위해 다른 형식의 세부 테스트 기법을 사용하기로 결정한 경우, 감사인은 속성 샘플에서 이미 테스트된 항목을 새로운 샘플에 포함하고, 나머지 테스트되지 않은 항목에서 추가 항목을 선택  (예를 들어, 속성 표본 크기가 25이고 세부테스트 표본 크기가 35인 경우, 감사인의 새 표본은 속성 표본의 25와 나머지 추가 10개 항목으로 구성해야함)
